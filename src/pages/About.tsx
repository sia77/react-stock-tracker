            ...
            <Card className="mb-4 p-4 border rounded-xl shadow-none">
                <CardContent className="">
                    <main>
                        ...
                        <p className="mb-[30px]"><span className="font-bold">StockTracker</span> is a showcase application built to demonstrate my proficiency with Angular and modern front-end development practices.</p>
                        ...
                        <p className="mb-[30px]">The application highlights key Angular concepts such as component architecture, reactive forms, state management, and API integration.</p> 
