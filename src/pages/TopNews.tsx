    ...
    return (
        <div className="max-w-8xl mx-auto">
        {
            ...
            <div className="flex justify-center mt-8">
                <button className="cursor-pointer group flex items-center gap-2 px-8 py-3 rounded-full bg-stockTrackerBlue text-white font-semibold hover:bg-stockTrackerBlack transition-all shadow-md hover:shadow-xl">
                    More
